...
void displayCaloricChart(){
    printf("\n\t\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Caloric Chart \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n\n");
    int x;
    printf("\n\t\tWhat kind of exercise you take : \n");
    printf("\t\t1. Lite or no exercise\n");
    printf("\t\t2. Medium exercise/sports 3-5 days/week\n");
    printf("\t\t3. Hard exercise/sports 6-7 days a week\n\n");
    ...
    {
    case 1:
        printf("\n\t\t\t\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Lite Exercise \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n\n");
        ...
        break;
    case 2:
        printf("\n\t\t\t\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Medium Exercise \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n\n");
        printf("\n\t\tAge Group (years)           Women (calories/day)            Men (calories/day)\n");
        printf("\t\t------------------------------------------------------------------------------\n");
        ...
        break;
    case 3:
        printf("\n\t\t\t\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Hard Exercise \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n\n");
        printf("\n\t\tAge Group (years)           Women (calories/day)            Men (calories/day)\n");
        printf("\t\t------------------------------------------------------------------------------\n");
